...
``https://github.com/Sayedmajidali/BlockChain-Based-Document-Verfication-ChainProof``


2. Install the required packages:

``cd BlockChain-Based-Document-Verfication-ChainProof
npm install``
...
# https-githubBlockChain-Based-Certificate-Verfication-ChainProof
